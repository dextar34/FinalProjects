...
const Blog2 = () => {
  return (
    <div>
        ...
        <Blog_card className="!max-w-[856px]" href='/tips/for/prepping/and/caring/for/your/grill' extraClass="hover:underline" src={StakeLarge} alt="../layer/SearchBlog" date='16 Apr 2021' shape='- Annalisa L' heading='tips for prepping and caring for your grill' to='#' more=' -Read More'/>
