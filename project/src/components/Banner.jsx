...
import Spone from '../assets/spoon.png'
...
const Banner = () => {
  ...
  var settings = {
    ...
    customPaging: i => (
      <div className={i == active ?"text-white font-Cormorant font-semibold text-lg after:w-4 after:h-[2px] after:bg-[#DCCA87] after:absolute relative pr-6 after:right-0 after:top-1/2 after:translate-y-[100%] ":"text-[#F5EFDB] font-Cormorant font-semibold text-lg"
      }>
        0{i + 1}
      </div>
    )
    ...
    return (
      <div className='pt-12 pb-[216px] bg-[#0C0B08] text-white '>
      <div className="fixed z-50 right-[120px] bottom-[152px] cursor-pointer">
        ...
        <h3 className='inline-block text-[#DCCA87] font-Cormorant font-bold text-base'>Scroll</h3>
      </div>
      ...
      <div className=" -rotate-90 flex gap-10">
        ...
        <p className='hover:text-[#DCCA87] duration-300'>#Gericht</p>
        </Link>
      </div>
      <div className="">
        <p className='font-Cormorant bold text-[23px] pb-2 capitalize'>Chase the new Flavour</p>
        <img className='pb-2 animate-pulse	animation:pulse' src={Spone} alt="" />
        <h1 className='pb-8 font-Cormorant bold text-[90px] text-[#DCCA87] max-w-[453px] leading-[130%] capitalize'>The key to Fine dining</h1>
      ...
      <div className="w-[667px] mr-[190px]">
      <Slider {...settings}>
